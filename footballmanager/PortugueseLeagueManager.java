...
public class PremierLeagueManager implements LeagueManager{
    ...
    private void displayMenu() {
        ...
        while(true){
            System.out.println("/*********************************************/");
            System.out.println("/*********** Portuguese League Menu: ***********/");
            System.out.println("1 - Create a new team and add it to league");
            System.out.println("2 - Delete existingteam from league");
            System.out.println("3 - Display Statistics for a team");
            System.out.println("4 - Display Premier League table");
            System.out.println("5 - Add a Played Match");
            System.out.println("6 - Display Calendar and Find a Match");
            System.out.println("/*********************************************/");
    ...
    private void addTeam(){
        ...
        if(league.size() == numberOfClubs){
            System.out.println("Cant add more clubs to the league");
            return;
        }
    ...
    private void displayStatistics(){
        ...
        for(FootballClub club : league){
            if(club.getName().equals(line)){
                ...
                System.out.println("Club " + club.getName() + " receieved goals: " + club.getReceivedGoalsCount());
    ...
    private void displayLeagueTable(){
        ...
        for(FootballClub club : league){
            System.out.println("Club: " + club.getName() + "Points: " + club.getPoints() + "Goal Difference: " + (club.getScoredGoalsCount() - club.ReceivedGoalsCount()));
        }
    }
    ...
    private void addPlayedMatch(){
        ...
        FootballClub home = null;
            ...
            try{
                ...
                if(homeGoals == -1){
                    System.out.println("You have to enter a number of goals");
                    return;
                }
            ...
            matches.add(match);
            home.setScoreGoalsCount(home.getScoredGoalsCount() + homeGoals);
            away.setScoreGoalsCount(away.getScoredGoalsCount() + awayGoals);
            ...
            if(homeGoals > awayGoals){
                ...
                home.setPoints(home.getWinCount()+1);
                away.setPoints(away.getDefeatCount()+1);
            }
    ...
    private void displayCalendar(){
        ...
        int M = 0;
            ...
            System.out.println("S M Tu W Th F S D");
